...
suite('Contx Extension Test Suite', () => {
    vscode.window.showInformationMessage('Start all tests.');

    test('Extension should be present', () => {
        assert.ok(vscode.extensions.getExtension('bethington.contx'));
    });

    test('Should activate extension', async () => {
        const extension = vscode.extensions.getExtension('bethington.contx');
    ...
    test('Should register command', async () => {
        ...
        assert.ok(commands.includes('contx.copyToClipboard'));
    });
    ...
    test('Should copy file content to clipboard', async function () {
        ...
        try {
            ...
            // Execute the command
            await vscode.commands.executeCommand('contx.copyToClipboard', document.uri);
